...
const aboutTextp1 = 'Welcome to my web-developer/programmer portfolio website! My name is Veikko and I am a passionate web developer and programmer with a strong background in both front-end and back-end development. I have experience in a variety of programming languages, including golang, php, javascript and python, and I am always eager to learn new technologies and stay up-to-date with the latest industry trends.'
